...
module.exports.bootstrap = function (cb) {
    sails.Db = require('mongodb').Db,
        ...
        sails.myurl = "http://vignesh.com/",
        sails.fromEmail = "info@wohlig.com",
        sails.fromName = "Wohlig",
        sails.mandrill = require('mandrill-api/mandrill'),
        sails.mandrill_client = new sails.mandrill.Mandrill('UrZPs-n-xIpapWNeHB1p1A');
    // Connection URL
    sails.url = 'mongodb://localhost:27017/flexisails';
